...
const TripTile: React.FC<{
    ...
    const classes = 'relative z-0 bg-neutral-200 overflow-hidden flex items-center justify-center p-[2em] w-[300px] h-[180px] border rounded-lg  trip-tile ' + (isOver ? 'border-[lightblue] border-[3px]' : 'border-gray-200');
